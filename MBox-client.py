...
class Playlist:
    ...
    def draw(self):
        self.winH.border()
        self.winH.addstr(1, 35, "***** MBOX CLIENT *****",curses.A_DIM)
        self.winH.noutrefresh()
        self.winPL.clear()
        self.winPL.border()
        self.winPL.addstr(1,5,"INDEX",curses.A_BOLD)
        self.winPL.addstr(1,15,"CALLER",curses.A_BOLD)
        self.winPL.addstr(1,35,"TITLE",curses.A_BOLD)
        self.winPL.addstr(1,65,"LENGTH",curses.A_BOLD)
        if len(self.playlist) ==  0:
            self.winPL.addstr(10,25,"Please wait,recordlist is being downloaded.")
        else:
        ...
        self.winNPL.clear()
        self.winNPL.border()
        self.winNPL.addstr(1,5,"NOW LISTENING:",curses.A_BOLD) 
        if self.cursor != -1:
